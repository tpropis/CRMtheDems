  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Hero animation — 10s loop explaining the Privilege Vault flow
        'hero-doc': {
        ...
        'hero-ai': {
          '0%, 22%':  { opacity: '0', transform: 'scale(0.85)' },
          '34%':      { opacity: '1', transform: 'scale(1)' },
          '80%':      { opacity: '1', transform: 'scale(1)' },
          '90%':      { opacity: '0', transform: 'scale(0.92)' },
      ...
      animation: {
        ...
        'hero-doc':    'hero-doc 10s ease-in-out infinite',
        'hero-arrow1': 'hero-arrow1 10s ease-in-out infinite',
        'hero-ai':     'hero-ai 10s ease-in-out infinite',
        'hero-arrow2': 'hero-arrow2 10s ease-in-out infinite',
        'hero-output': 'hero-output 10s ease-in-out infinite',
        'hero-audit':  'hero-audit 10s ease-in-out infinite',
      },
    },
  },
